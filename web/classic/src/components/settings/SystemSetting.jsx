            ...
            >
              ...
              <Card>
                <Form.Section text={t('配置 Google OAuth')}>
                  ...
                  <Banner
                    type='info'
                    description={`${t('Authorized JavaScript origins 填')} ${inputs.ServerAddress ? inputs.ServerAddress : t('网站地址')}，${t('Authorized redirect URI 填')} ${inputs.ServerAddress ? inputs.ServerAddress : t('网站地址')}/oauth/google`}
                    style={{ marginBottom: 20, marginTop: 16 }}
                  />
                  <Row
                    gutter={{ xs: 8, sm: 16, md: 24, lg: 24, xl: 24, xxl: 24 }}
