...
func InitOptionMap() {
	...
	common.OptionMap["AffCommissionRateNormal"] = strconv.FormatFloat(common.AffCommissionRateNormal, 'f', -1, 64)
...
func updateOptionMap(key string, value string) (err error) {
	...
	case "AffCommissionEnabled":
		common.AffCommissionEnabled = value == "true"
	case "AffCommissionRateNormal":
		common.AffCommissionRateNormal, _ = strconv.ParseFloat(value, 64)
	case "AffCommissionRateAdvanced":
		common.AffCommissionRateAdvanced, _ = strconv.ParseFloat(value, 64)
	case "AffAdvancedSingleTopUp":
